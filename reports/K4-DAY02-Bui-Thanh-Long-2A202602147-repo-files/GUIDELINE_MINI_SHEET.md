...
- [ ] Số vật thể thực tế: 89 (sau khi xoá 37 hộp không đủ căn cứ, giảm từ 126 ban đầu) — 40–60 là mục tiêu khối lượng, không phải điểm cắt; vẫn cao hơn mục tiêu nên bạn tự cân nhắc có cần rà thêm phạm vi không trước khi tick hộp này.
